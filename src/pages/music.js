        ...
        <ProjectContainer>
          ...
          <div>
            <p>
              ...
              for weddings, private parties, and corporate events. Playing
              mostly reimagined jazz standards and familiar tunes, the trio
              creates a classy atmosphere for any occasion.
            </p>
            <p>
              Three Sharp was formed as pianist Ammon Doman, drummer Matt
              Tippetts reunited after many years. We had each performed with one
              another in college, but never in the same group. We decided to jam
              one day long after we had all graduated, and we have been a group
              ever since.
            </p>
          </div>
          <a
        ...
        <ProjectContainer>
          ...
          <div>
            <p>
              ...
              over 10 years. I am currently the Principle Bassist performing in
              multiple genres and groups.
            </p>
            <p>
              I perform a wide variety of roles in the unit; bassist and backup
              singer for the rock band Article 15, leader and bassist for the
              jazz combo Sensational Seven, and bassist and percussionist for
              the concert band. I also perform other duties such as social media
